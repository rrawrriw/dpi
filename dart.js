...
Interceptor: {"": "Object;",
  ...
  "%": "ArrayBuffer|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList|SVGAnimatedString"
},
...
InputElement: {"": "HtmlElement;files=,height=,name=,src},value%,width=", "%": "HTMLInputElement"},
...
main: function() {
  ...
  t3._tryResume$0();
  t3 = document.querySelector("#img_path_tmp");
  t3.toString;
...
main_closure1: {"": "Closure;",
  call$1: function(e) {
    ...
    files = J.get$files$x(document.querySelector("#img_path_tmp"));
    t1 = files.length;
    if (t1 === 1) {
      if (0 >= t1)
      ...
      C.FileReader_methods.addEventListener$2(reader, "load", new N.main__closure(img, reader));
...
main__closure: {"": "Closure;img_0,reader_1",
  call$1: function(e) {
    var t1;
    J.set$value$x(document.querySelector("#img_path"), this.img_0.name);
    t1 = this.reader_1;
